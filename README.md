NEXAA - Next-Gen AI Association 
This is a landing page I built for the CSE (AI & ML) Department. My main goal was to mix a "Royal" look with a high-tech vibe using a clean frontend structure.
...
CSS3: Used CSS Variables for easy theme management, along with Flexbox and Grid for the layout.
Fonts: A professional pairing of Cinzel for headings and Montserrat for body text.
Developed by Saisri Gandla. Just a frontend dev who loves building clean, fast, and visually sharp web interfaces.
